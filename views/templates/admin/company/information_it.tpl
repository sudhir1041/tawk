                    ...
                    <div class="row util-links">
                        <div class="col-lg-12">
                            <p>
                                ...
                                <i class="icon-external-link"></i> <a target="_blank" title="Documentazione" href="{if isset($doc_url)}{$doc_url|escape:'htmlall':'UTF-8'}{else}{$this_path|escape:'htmlall':'UTF-8'}readme_it.pdf{/if}">Documentazione</a><br/><br/>
                            ...
                            {for $counter=0 to 2}
                                ...
                                <div class="col-md-4 column">
                                    <div class="module module-modules">
                                        <a target="_blank" href="https://addons.prestashop.com/it/{$modules[$moduleKey|escape:'htmlall':'UTF-8']['id']|escape:'htmlall':'UTF-8'}-.html" title="{$modules[$moduleKey|escape:'htmlall':'UTF-8']['name']|escape:'htmlall':'UTF-8'}">
